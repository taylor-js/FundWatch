        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SimulatedPurchaseDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    SimulatedPurchasePrice = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    SimulatedNumberOfShares = table.Column<int>(type: "integer", nullable: false),
                    SimulatedCurrentPrice = table.Column<decimal>(type: "numeric(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "text", nullable: false),
                    StockSymbol = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    TransactionType = table.Column<string>(type: "character varying(4)", maxLength: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfSharesPurchased = table.Column<int>(type: "integer", nullable: false),
                    ...
                    NumberOfSharesSold = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
